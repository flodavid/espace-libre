...
public class EspaceLibre.VolumeEntry : Object {
    ...
    public VolumeEntry (string uuid, string file_system, string? mount_point, string format_type, string mount_options,
        string dump, string pass
    ) {
        Object (uuid: uuid, file_system: file_system, mount_point: mount_point, fs_type: format_type,
